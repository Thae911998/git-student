...
<body>
	...
	<div id="sub_content">
		<form:form action="/student_registration/addstudent" method="post"
			...
			<div class="row mb-4">
				...
				<div class="col-md-4">
					<form:input type="text" class="form-control" path='student_name'
						value="Harry"></form:input>
				</div>
			</div>
			<div class="row mb-4">
				<div class="col-md-2"></div>
			...
			<fieldset class="row mb-4">
				...
				<div class="col-md-4">
					<div class="form-check-inline">
						<form:radiobutton path="gender" id="genderMale" value="Male"
							checked="true" />
			...
			<div class="row mb-4">
				...
				<div class="col-md-4">
					<form:select path="education" class="form-select" id="education"
						required="true">
						<form:options items="${selected_education}" itemValue="eid"
							itemLabel="ename" />
					</form:select>
				</div>
			</div>
			...
			<fieldset class="row mb-4">
						...
						<div class="col-md-4">
							<div class="col-md-10">
								<form:checkboxes items="${selected_course}"  path="course" itemValue="id" itemLabel="course_name"></form:checkboxes>
								<span> </span>
							</div>
						</div>
			</fieldset>
